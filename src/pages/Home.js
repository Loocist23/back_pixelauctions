...
/**
 * Home component that serves as the landing page of the PixelAuction platform.
 * It provides an overview of the platform's features and guides on how to start using it.
 */
const Home = () => {
